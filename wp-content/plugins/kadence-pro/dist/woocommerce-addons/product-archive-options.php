...
Theme_Customizer::add_settings(
	array(
		...
		'product_archive_shop_custom' => array(
			...
			'input_attrs'  => array(
				'help' => esc_html__( 'This will use the page content of your shop page instead of the WooCommerce archive loop.', 'kadence-pro' ),
			),
			'transport'    => 'refresh',
		),
...
$widget_settings = array(
	...
	'product_filter_widget_settings' => array(
		'control_type' => 'kadence_blank_control',
		'section'      => 'sidebar-widgets-product-filter',
		'settings'     => false,
		'priority'     => 10,
