...
namespace KadenceWP\ReCaptcha\StellarWP\Telemetry\Exit_Interview;
...
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Config;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Contracts\Template_Interface;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \KadenceWP\ReCaptcha\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \KadenceWP\ReCaptcha\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
