...
namespace KadenceWP\ReCaptcha\StellarWP\Telemetry;

use KadenceWP\ReCaptcha\StellarWP\ContainerContract\ContainerInterface;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Admin\Admin_Subscriber;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Admin\Resources;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Contracts\Data_Provider;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Data_Providers\Debug_Data;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Events\Event_Subscriber;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Exit_Interview\Template;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Last_Send\Last_Send;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Opt_In\Status;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Telemetry\Telemetry;
use KadenceWP\ReCaptcha\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \KadenceWP\ReCaptcha\StellarWP\ContainerContract\ContainerInterface
	 */
