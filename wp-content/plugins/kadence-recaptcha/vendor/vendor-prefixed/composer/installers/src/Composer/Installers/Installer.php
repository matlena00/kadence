...
class Installer extends LibraryInstaller
{
    ...
    public function getInstallPath(PackageInterface $package)
    {
        ...
        $class = 'KadenceWP\\ReCaptcha\\Composer\\Installers\\' . $this->supportedTypes[$frameworkType];
        /**
         * @var BaseInstaller
         */
    ...
    protected function getLocationPattern(string $frameworkType): string
    {
        ...
        if (!empty($this->supportedTypes[$frameworkType])) {
            $frameworkClass = 'KadenceWP\\ReCaptcha\\Composer\\Installers\\' . $this->supportedTypes[$frameworkType];
